...
export default function Header() {
    ...
    useEffect(()=>{
        scrollY.onChange(() => {if(scrollY.get()) {
            barAnimation.start({
    ...
    },[scrollY, barAnimation, scrollYProgress]);


    return <Navbar animate={barAnimation}>
        <Items>
            ...
            <Item>
                <Search>
                    <motion.svg viewBox="0 0 20 20"
                        ...
                        initial={{x: 0}}
                        animate={{x: openSearch ? "-230px": "0px"}}
